...
export const OPTIONS = {
  ...
  options: {
    ...
    demandOption: false,
    describe:
      'после ввода --options, выберите в каком формате необходимо создать архив. Доступно 3 дополнительных команды:\ntgz - создаст архив с расширением tar.gz; tar - создаст архив с рашрирением tar; zip - создаст архив с расширением zip\nВ конце строки не забудьте передать в качестве аргумента название дир-рии которую необходимо заархивировать.',
  },
};
