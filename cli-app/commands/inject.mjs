...
export const describe = `
  команда по импорту файла стилей scss компонента, в файл _components_import.scss.
  Не нужно указывать путь до файла стилей компонента, не нужно указывать расширение, необходимо передать только название компонента т.к. файл стилей имеет аналагичное название.
  `.trim();
